...
export default function AdminDashboard() {
  ...
  window.renderProsPage = function renderProsPage() {
    document.getElementById("page-pros").innerHTML = `
      <div class="page-head"><button class="btn btn-ghost btn-sm" onclick="exportMock('Liste des professionnels')">${iconPrinter()} Exporter</button></div>
  ...
  window.renderClientsPage = function renderClientsPage() {
    document.getElementById("page-clients").innerHTML = `
      <div class="page-head"><button class="btn btn-ghost btn-sm" onclick="exportMock('Liste des clients')">${iconPrinter()} Exporter</button></div>
  ...
  window.renderRdvPage = function renderRdvPage() {
    document.getElementById("page-rdv").innerHTML = `
      <div class="page-head"><button class="btn btn-ghost btn-sm" onclick="exportMock('Liste des réservations')">${iconPrinter()} Exporter</button></div>
      <div class="filter-row">
  ...
  window.renderNotifsPage = function renderNotifsPage() {
    document.getElementById("page-notifs").innerHTML = `
      <div class="page-head"><button class="btn btn-ghost btn-sm" onclick="markAllRead()">Tout marquer comme lu</button></div>
